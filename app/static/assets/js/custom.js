...
(function ($) {
  ...
  //mobile nav
	...
	$( function() {
		var _min = height_min
		var _max = height_max
		var _smin = height_smin
		var _smax = height_smax
		...
		$( "#height-min" ).val($( "#slider-range-height").slider( "values", 0 ));
		$( "#height-max" ).val($( "#slider-range-height").slider( "values", 1 ));
	} );	
	// Width
	$( function() {
		var _min = width_min
		var _max = width_max
		var _smin = width_smin
		var _smax = width_smax
		$( "#slider-range-width" ).slider({
			...
			values: [ +_smin, +_smax ],
			slide: function( event, ui ) {
				$("#width-min").val(ui.values[ 0 ]);
				$("#width-max").val(ui.values[ 1 ]);
			}
		});
		$("#width-min").val($( "#slider-range-width").slider( "values", 0 ));
		$("#width-max").val($( "#slider-range-width").slider( "values", 1 ));
	} );
	// Temperature
	$( function() {
		var _min = temp_min
		...
		$( "#temp-min" ).val($( "#slider-range-temp").slider( "values", 0 ));
		$( "#temp-max" ).val($( "#slider-range-temp").slider( "values", 1 ));
	} );
    ...
    $('.count').each(function () {
		$(this).prop('Counter', 0).animate({
			Counter: $(this).text().toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")
		}, {
			duration: 4000,
			easing: 'swing',
			step: function (now) {
